package com.petMed.user.service.impl;
...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public void registerVet(VetRegisterRequest vetRegisterRequest) {
        ...
        Clinic clinic = clinicService.createClinicFromRegisterRequest(vetRegisterRequest);
    ...
    public void updateVetProfile(UUID userId, VetData vetData) {
        ...
        Clinic clinic = clinicService.createClinicFromVetData(vetData);
